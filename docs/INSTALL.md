...
Complete binaries distributed in a file such rwloadsim-linux-x86_64-bin-2.3.1.tgz
...
use a file like rwloadsim-linux-x86_64-binonly-2.3.1.tgz.
...
use a command like
```
tar -zxvf rwloadsim-linux-x86_64-bin-2.3.1.tgz
```
...
```
tar -zxvf rwloadsim-linux-x86_64-binonly-2.3.1.tgz
```
