...
you can simply type "make" in the src directory.
...
You can do "make clean" first to make sure everything gets recompiled with -g.
...
Previously the source code had very rudimentary support for sharding.
